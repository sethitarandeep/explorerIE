 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme kurama for publication on WordPress.org
...
add_action( 'tgmpa_register', 'kurama_register_required_plugins' );
 ...
 */
function kurama_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'		  => __('WPForms-Lite Contact Form Plugin', 'kurama'),
			'slug'		  => 'wpforms-lite',
			'required'	  => false
		),
	 ...
	 */
	$config = array(
		'id'           => 'kurama',                 // Unique ID for hashing notices for multiple instances of TGMPA.
