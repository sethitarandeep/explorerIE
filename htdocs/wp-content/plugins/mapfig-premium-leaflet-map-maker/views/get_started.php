...
<section id="social plugin" class="wrapssss" >
	...
	<p class="style11">MapFig is designed to easily add stylish, meaningful maps to your WordPress site. </p>
	<p class="style11">The plugin is designed for ease of use and to offer a full array of features.</p>
	<p class="style12">If you would like to view a video or read full documentation, please visit <a href="https://www.mapfig.com/leaflet-map-plugin/docs/" target="_blank">https://www.mapfig.com/leaflet-map-plugin/docs/</a>.</p>
	<p>&nbsp; </p>
	...
	<p>&nbsp;</p>
	<p><span class="style10"><strong>Step 4.)</strong> Add your map(s) to your Posts or Pages by clicking on the Add MapFig Map button above the editor.</span> </p>
	...
	<p align="center"><span class="style2 style11">Your MapFig Plugin includes an integrated Widget! For Widget information, see the <a href="<?=admin_url().'admin.php?page=get_started_widget'?>">Widget Page</a> </span></p>
	<p>&nbsp; </p>

	<p><span class="style2"><strong>Downloading Maps and JSON </strong>:</span></p>
	<p>MapFig maps are made to be self-contained. On your <a href="<?=admin_url().'admin.php?page=my-maps'?>">MyMaps</a> page, you can download your maps if you wish to use them outside of WordPress.</p>
	<p>You can also download the GeoJSON source as well.</p>
	<p><span class="style2"><strong>About MapFig </strong>:</span></p>
	<p>MapFig is produced by <a href="htttps://www.acugis.com" target="_blank">AcuGIS</a>. AcuGIS provides GIS hosting services to individuals, corporations, and leading research and educational institutions in over 40 countries worldwide. </p>
	<p><strong>MapFig Version 3.0.1</strong></p>
	<p><span class="style2"><strong>Terms </strong>:</span></p>
	<p>In using this plugin, you are agreeing to the <a href="http://www.openstreetmap.org/copyright" target="_blank">license requirement</a> to retain attribution to <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a>. You are also agreeing to maintain attribution to any other tile providers used as well as <a href="https://www.mapfig.com" target="_blank">MapFig</a> and to <a href="http://leafletjs.com/" target="_blank">Leafletjs</a> as well. </p>
	...
	<p>Please see our website at <a href="https://www.mapfig.com" target="_blank">https://www.mapfig.com</a> to check for updates as well as full documentation.</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>

	<p align="center">Copyright @ 2015 MapFig, Inc |  <a href="http://www.acugis.com/" target="_blank">AcuGIS</a></p>
	<p align="center"><img src="<?php echo plugins_url('../screenshots/logo.png', __FILE__) ?>" ></p>
	<p align="center">We make GIS simple. </p>
	<p>&nbsp;</p>
	<p><strong>MapFig, Inc</strong></p>
	<ul>
	  <li>
	...
	<p><strong>MapFig Europe </strong></p>
