            ...
            <div class="col-md-10  product-main-cont">
			  ...
			  <div class="wrap elw-page-welcome about-wrap seting-page">
                <div class="col-md-12 settings">
                    <div class=" col-md-2 col-md-offset-1">
                        <div class="header-logo">
                            <img  src="<?php echo WL_Page_Ainm_URI. '/images/weblizar2.png'; ?>" alt="logo" />
                        </div>
                    </div>
                     <div class=" col-md-8">
                ...
                <ul class="nav nav-tabs product-tbs">
                    <li class=""><a data-toggle="tab" href="#themesd" onclick="themes()"> Themes </a></li>
                    <li><a data-toggle="tab" href="#pluginsd" onclick="plugins1()">Plugins</a></li>
					<li><a data-toggle="tab" href="#offers2" onclick="offers()">Offers</a></li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="themesd" class="tab-pane  ">
                        <div class="space  theme ">
                            ...
                            <div class="  p_plugin blog_gallery clearfix">
                                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                    <div class="img-thumbnail">
                                        <img src="<?php echo WL_Page_Ainm_URI.'/images/BeautySpa.jpg'; ?>" class="img-responsive" alt="img"/>
                            ...
                            <div class="  p_plugin blog_gallery clearfix clearfix">
                                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                    <div class="img-thumbnail">
                                          <img src="<?php echo WL_Page_Ainm_URI.'/images/personal.jpg'; ?>" class="img-responsive" alt="img"/>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                    <div class=" p-box">
                            ...
                            <div class="  p_plugin blog_gallery clearfix clearfix">
                                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                    <div class="img-thumbnail">
                                        <img src="<?php echo WL_Page_Ainm_URI.'/images/explora.jpg'; ?>" class="img-responsive" alt="img"/>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                    <div class=" p-box">
                            ...
                            <div class="  p_plugin blog_gallery clearfix clearfix">
                                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                    <div class="img-thumbnail">
                                     <img src="<?php echo WL_Page_Ainm_URI.'/images/Guardian.jpg'; ?>" class="img-responsive" alt="img"/>
                            ...
                            <div class="   p_plugin blog_gallery clearfix clearfix">
                                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                    <div class="img-thumbnail">
                                      <img src="<?php echo WL_Page_Ainm_URI.'/images/Enigma.jpg'; ?>" class="img-responsive" alt="img"/>
                    ...
                    <div id="pluginsd" class="tab-pane " onclick="plugins()">
						...
						<div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                     <img src="<?php echo WL_Page_Ainm_URI.'/images/Clockin-Pro.jpg'; ?>" class="img-responsive" alt="img"/>
                        ...
                        <div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                     <div class="img-thumbnail">
                                        <img src="<?php echo WL_Page_Ainm_URI.'/images/facebook-feed.jpg'; ?>" class="img-responsive" alt="img"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        ...
                        <div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                     <img src="<?php echo WL_Page_Ainm_URI.'/images/Pinterest-Feed.jpg'; ?>" class="img-responsive" alt="img"/>
                               </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                <div class=" p-box">
                        ...
                        <div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                     <img src="<?php echo WL_Page_Ainm_URI.'/images/Search-Engine-Optimizer-new.jpg'; ?>" class="img-responsive" alt="img"/>
                                  </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                <div class=" p-box">
                        ...
                        <div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                     <img src="<?php echo WL_Page_Ainm_URI.'/images/newsletter.png'; ?>" class="img-responsive" alt="img"/>
                               </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                <div class=" p-box">
                        ...
                        <div class="   p_plugin blog_gallery clearfix clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                       <img src="<?php echo WL_Page_Ainm_URI.'/images/Comingsoon.jpg'; ?>" class="img-responsive" alt="img"/>
                                 </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                <div class=" p-box">
                        ...
                        <div class="  p_plugin blog_gallery clearfix">
                            <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                <div class="img-thumbnail">
                                       <img src="<?php echo WL_Page_Ainm_URI.'/images/responsive-pro.jpg'; ?>" class="img-responsive" alt="img"/>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                                <div class=" p-box">
					     ...
					     <div id="offers2" class="tab-pane" onclick="offers()">
                            <div class="space  theme">
                                ...
                                <div class="  p_plugin blog_gallery clearfix">
                                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                                        <div class="img-thumbnail">
                                            <img src="<?php echo WL_Page_Ainm_URI.'/images/offer.jpg'; ?>" class="img-responsive" alt="img"/>
