=== MapFig Leaflet Maps ===
Plugin Name:       MapFig Leaflet Maps
Plugin URI:        https://www.mapfig.com/leaflet-map-plugin/
Tags:              Google Maps, Maps, Leaflet, MapFig, OpenStreetMap, OSM, BING maps, MapBox Maps, Map
Author URI:        https://www.mapfig.com/leaflet-map-plugin/
Author:            MapFig
...
* [Plugin Home Page](https://www.mapfig.com/leaflet-map-plugin/)
* [Easy to Use](https://www.mapfig.com/leaflet-map-plugin/easy-to-use/)
* [Examples](https://www.mapfig.com/leaflet-map-plugin/examples/)
* [Docs and Help](https://www.mapfig.com/leaflet-map-plugin/docs/)
...
The MapFig Leaflet Map plugin is designed for ease of use.  Just click the marker icon and drop it onto the map.  Enter the location or address and address auto-complete will place the marker where you want it.  
...
The MapFig Leaflet Map plugin is 100% free with a limit of 5 maps.  
...
https://www.mapfig.com/leaflet-map-plugin/

* [MapFig Leaflet Maps Docs](https://www.mapfig.com/leaflet-map-plugin/docs/) - [MapFig Docs](https://docs.mapfig.com/faq/) - [FAQ](https://www.mapfig.com/faq/) - [Support](https://www.mapfig.com/portal/) - [Twitter](https://twitter.com/MapFig) - [Facebook](https://facebook.com/MapFig) - [GitHub](https://www.github.com/MapFig)
...
For basic usage and tutorials, please see [MapFig Leaflet Maps Plugin Docs](https://www.mapfig.com/leaflet-map-plugin/docs/)
...
For basic usage and tutorials, please see [MapFig Leaflet Maps Plugin Docs](http://docs.mapfig.com/wordpress-premium-leaflet-plugin/) 
...
1. [Plugin Home Page](https://www.mapfig.com/leaflet-map-plugin/)
2. [Easy to Use](https://www.mapfig.com/leaflet-map-plugin/easy-to-use/)
3. [Examples](https://www.mapfig.com/leaflet-map-plugin/examples/)
4. [Docs and Help](https://www.mapfig.com/leaflet-map-plugin/docs/)
...
MapFig was created and is maintained by AcuGIS. AcuGIS provides GIS hosting services to some of the world's leading academic and research institutions as well as individuals and business of all sizes.

In addition to our stand-alone WordPress Plugin, you can also use our free [Public Cloud](https://studio.mapfig.com/)

Our Public Cloud includes a free WordPress API plugin that allows you to import maps from our Public cloud into WordPress.
...
MapFig Inc &reg;
Copyright 2016, MapFig Inc, MapFig, Ltd, All Rights Reserved
